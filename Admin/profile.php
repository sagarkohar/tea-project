                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Gender</label><input type="text"
                                class="form-control" name="gender" placeholder=""
                                value="<?php echo $gender ?> "disabled>
                        </div>
                        <div class="col-md-12"><label class="labels">Mobile Number</label><input type="text"
                                class="form-control" name="phone" placeholder="" value="<?php echo $phone ?> "disabled >
                        </div>
                        <div class="col-md-12"><label class="labels">Address Line 1</label><input type="text"
                                class="form-control" name="address" placeholder="" value="<?php echo $address ?> "disabled>
                        </div>
                        ...
                        <div class="col-md-12"><label class="labels">Password</label>
                            <div class="password-container"><input type="password" class="form-control"
                                    placeholder="enter password" name="password" id="password"
                                    value="<?php echo $password ?>" disabled>

                                <i class="fas fa-eye password-icon" onclick="togglePassword()" id="togglePassword"></i>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-6"><label class="labels">State</label><input type="text"
                                    class="form-control" name="st" placeholder=""
                                    value="<?php echo $state ?>" disabled>
                            </div>
                            <div class="col-md-6">
