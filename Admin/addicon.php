...
if (isset($_POST['btn'])) {
    ...
    $insert = "INSERT INTO brand_icon (brand)
           VALUES ('$new_filename')";
            ...
            <div class="col-sm-12 col-md-12 text-dark">
                <div class="card ">
                    ...
                    <div class="card-img-overlay d-flex align-items-center justify-content-center">
                        <h2 class="card-title text-dark text-uppercase">Add Brand Icon</h2>
        ...
        <div class="container bg-white text-dark shadow-lg bg-body rounded w-100 ">
            <div class="row">
                <div class="col-sm-12 col-md-12 bg-white text-dark">
                    <p class="text-success">Dashboard <span class="text-dark text-uppercase">|Add Brand Icon</span></p>
                </div>
            </div>
        </div>

        <h3 class="text-uppercase text-center my-5">Add Brand Icon</h3>
